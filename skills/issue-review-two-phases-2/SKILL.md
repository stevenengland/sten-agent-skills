...
description: >
  ...
  then perform a refactor pass, file a PR, and monitor CI to green.
  Stages and commits changes. Use when a plan already exists on the issue.
  Part 2 of the issue-review-two-phases workflow.
