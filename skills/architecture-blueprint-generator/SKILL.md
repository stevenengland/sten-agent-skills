...
description: Generate comprehensive architecture documentation from a codebase — stack/pattern detection, diagrams, implementation patterns, and extensible blueprints.
---
